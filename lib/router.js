...
router.post('/mobile/updateProduct',[authCheck],(req,res)=>{
    terminateFunction(req,res,QueryProvider.updateProduct(req.body.id,req.body.price,req.body.name,req.body.barcode))
})

router.post('/mobile/addProduct',[authCheck],(req,res)=>{
    terminateFunction(req,res,QueryProvider.addProduct(req.body.name,req.body.price,req.body.barcode,req.body.shopId))
})
